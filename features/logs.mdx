...
Logs is an integrated log analysis feature within Blocks that combines the intuitiveness of natural language queries with the power of OpenSearch. It simplifies navigating through vast amounts of log data to provide you with the insights you need.

<Frame>
  <img src="/images/logs.png" style={{ borderRadius: "0.5rem" }} />
</Frame>

## How Logs Enhances Blocks
...
| Feature                  | Description                                                                        |
| ------------------------ | ---------------------------------------------------------------------------------- |
| **Intuitive Querying**   | Ask questions, get answers. Logs understands the context and content of your logs. |
...
By bringing Logs into the Blocks family, we aim to offer our users a seamless and powerful tool to turn their logs into a goldmine of insights, all with the convenience of natural language processing.
