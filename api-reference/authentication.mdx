...
3. Press the 'Generate new API Key' button.
...
```bash
curl -H 'Authorization: Bearer <your_personal_access_token>' https://api.structuredlabs.io/endpoint
```
...
For any additional information on how to use API tokens or to troubleshoot issues, please email us: support@structuredlabs.io.
