...
Integrate popular ETL tools like Fivetran and Airflow with Structured to automate and streamline your data extraction, transformation, and loading processes.

---

<CardGroup cols={2}>
  <Card title="Fivetran" icon="f" href="#fivetran-integration"></Card>
  <Card title="Airflow" icon="a" href="#airflow-integration"></Card>
</CardGroup>
